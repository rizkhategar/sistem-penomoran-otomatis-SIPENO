        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @else
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 mb-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm text-gray-500 font-medium">Bidang {{ $bidang }}</p>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="px-6 py-5 border-b border-gray-100 flex justify-between items-center">
                        <div>
                            <h3 class="font-semibold text-gray-800">Riwayat Surat Saya</h3>
                            <p class="text-sm text-gray-400 mt-0.5">Total {{ $submissions->total() }} surat</p>
                        </div>
                    </div>
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-50">
                            ...
                            <tbody class="divide-y divide-gray-50">
                                ...
                                <tr>
                                    <td colspan="5" class="px-6 py-16 text-center">
                                        ...
                                        <p class="text-gray-400 text-sm mb-4">Anda belum membuat surat apapun.</p>
