            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
                <form action="{{ route('admin.master-jenis-surats.store') }}" method="POST">
                    ...
                    <div class="mb-8">
                        ...
                        <textarea name="description" rows="3" class="w-full border-gray-200 rounded-xl shadow-sm focus:border-blue-500 focus:ring-blue-500 bg-gray-50 px-4 py-2.5">{{ old('description') }}</textarea>
                    </div>
