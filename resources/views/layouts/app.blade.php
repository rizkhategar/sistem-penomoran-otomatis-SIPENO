                    ...
                    <div class="flex items-center gap-2">
                        <div x-data="notifDropdown()" class="relative">
                            <button @click="toggle()" class="relative p-2 rounded-lg text-white/80 hover:text-white hover:bg-white/10 transition">
                                ...
                                <span x-show="unread > 0" x-text="unread > 9 ? '9+' : unread" class="absolute -top-0.5 -right-0.5 w-4.5 h-4.5 bg-red-500 text-white text-[10px] font-bold rounded-full flex items-center justify-center"></span>
                            </button>
                                ...
                                return {
                                    ...
                                    fetchNotifs() {
                                        fetch('{{ route("notifications.data") }}')
                                            .then(r => r.json())
                                            .then(d => { this.unread = d.unread; this.notifHtml = d.html; document.getElementById('notif-list').innerHTML = d.html; });
                                    },
